#pragma checksum "C:\Users\Edward\source\05.Git\Final Project 2\MetroAssetSystem\MAS.Client\Views\ProcurementEmployee\Category.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0b56c515cc918c5812e8cd5c1e011e471f95eb08"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0b56c515cc918c5812e8cd5c1e011e471f95eb08", @"/Views/ProcurementEmployee/Category.cshtml")]
    ...
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b56c515cc918c5812e8cd5c1e011e471f95eb085970", async() => {
                WriteLiteral(@"
            ...
            <div class=""modal-footer"">
                <button type=""button"" class=""btn btn-primary"" id=""buttonsubmit"" onclick=""SubmitCategory();"">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div class=""modal fade"" id=""updateModal"" tabindex=""-1"" role=""dialog"" aria-labelledby=""addModalLabel"" aria-hidden=""true"">
    <div class=""modal-dialog"" role=""document"">
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b56c515cc918c5812e8cd5c1e011e471f95eb088696", async() => {
                WriteLiteral(@"
                    <div class=""form-group"" hidden>
                        <label for=""id"" class=""col-form-label"">Id</label>
...
");
        ...
        $(document).ready(function () {
            table = $(""#mytables"").DataTable({
                ""ajax"": {
                    ""url"": ""https://localhost:44329/api/Category"",
                    ""datatype"": ""json"",
                    ""dataSrc"": ""data""
                },
                ""columnDefs"": [
                ...
                WriteLiteral(@"+ 1;
                    ...
                    {
                        ""render"": function (data, type, row, meta) {
                            return '<a href=""javascript:void(0)"" class=""far fa-edit table-action text-dark"" data-toggle=""tooltip"" data-placement=""top"" title=""Edit"" onclick=""return GetCategory(' + row['id'] + ')""></a>' +
        ...
        function SubmitCategory() {
            ...
            Category.name = $");
                ...
                $.ajax({
                    url: '/ProcurementEmployee/CreateCategory',
                    type: ""POST"",
                    data: Category
                }).done((result) => {
                    if (result == 200) {
        ...
        function GetCategory(id) {
            debugger;
                $.ajax({
                url: '/ProcurementEmployee/GetCategory',
                data: { id: id }
            }).done((result) => {
                console.log(result);
                var obj = JSON");
        ...
        function Update() {
            ...
            $('#updateModal').hide();
            $.ajax({
                url: ""/ProcurementEmployee/UpdateCategory"",
                type: ""put"",
                data: Category
            }).done((result) => {
                if (result == 200) {
        ...
        function Delete(id) {
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: 'DELETE',
                        url: '/ProcurementEmployee/DeleteCategory',
                        data: { id: id }
                    }).done((result) => ");
                WriteLiteral(@"{
                        if (result == 200) {
